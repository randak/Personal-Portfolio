...
use Randak\Personal\PortfolioBundle\Model\PageQuery;
...
abstract class BasePageQuery extends ModelCriteria
{
     ...
     */
    public function __construct($dbName = 'portfolio', $modelName = 'KristianRandall\\Bundle\\PortfolioBundle\\Model\\Page', $modelAlias = null)
    {
    ...
    {
        $sql = 'SELECT `id`, `name`, `content` FROM `page` WHERE `id` = :p0';
        try {
