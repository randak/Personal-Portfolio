...
use Randak\Personal\PortfolioBundle\Model\map\ProjectTableMap;
...
abstract class BaseProjectPeer
{
    ...
    const OM_CLASS = 'KristianRandall\\Bundle\\PortfolioBundle\\Model\\Project';
    ...
    protected static $fieldNames = array (
        BasePeer::TYPE_PHPNAME => array ('Id', 'Slug', 'Name', 'Content', 'Date', ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'slug', 'name', 'content', 'date', ),
        BasePeer::TYPE_COLNAME => array (ProjectPeer::ID, ProjectPeer::SLUG, ProjectPeer::NAME, ProjectPeer::CONTENT, ProjectPeer::DATE, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID', 'SLUG', 'NAME', 'CONTENT', 'DATE', ),
        BasePeer::TYPE_FIELDNAME => array ('id', 'slug', 'name', 'content', 'date', ),
    ...
    protected static $fieldKeys = array (
        BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'Slug' => 1, 'Name' => 2, 'Content' => 3, 'Date' => 4, ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'slug' => 1, 'name' => 2, 'content' => 3, 'date' => 4, ),
        BasePeer::TYPE_COLNAME => array (ProjectPeer::ID => 0, ProjectPeer::SLUG => 1, ProjectPeer::NAME => 2, ProjectPeer::CONTENT => 3, ProjectPeer::DATE => 4, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID' => 0, 'SLUG' => 1, 'NAME' => 2, 'CONTENT' => 3, 'DATE' => 4, ),
        BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'slug' => 1, 'name' => 2, 'content' => 3, 'date' => 4, ),
        BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, )
    );
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(ProjectPeer::CONTENT);
