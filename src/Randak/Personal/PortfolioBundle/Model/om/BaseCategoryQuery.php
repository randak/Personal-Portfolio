 ...
 *
 * @method CategoryQuery leftJoinProjectCategory($relationAlias = null) Adds a LEFT JOIN clause to the query using the ProjectCategory relation
 * @method CategoryQuery rightJoinProjectCategory($relationAlias = null) Adds a RIGHT JOIN clause to the query using the ProjectCategory relation
 * @method CategoryQuery innerJoinProjectCategory($relationAlias = null) Adds a INNER JOIN clause to the query using the ProjectCategory relation
 *
...
abstract class BaseCategoryQuery extends ModelCriteria
{
     ...
     */
    public function __construct($dbName = 'portfolio', $modelName = 'KristianRandall\\Bundle\\PortfolioBundle\\Model\\Category', $modelAlias = null)
    {
    ...
    public function filterByProjectCategory($projectCategory, $comparison = null)
    {
        if ($projectCategory instanceof ProjectCategory) {
            return $this
                ->addUsingAlias(CategoryPeer::ID, $projectCategory->getCategoryId(), $comparison);
