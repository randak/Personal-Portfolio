...
abstract class BaseProjectCategory extends BaseObject implements Persistent
{
     ...
     * Peer class name
     */
    const PEER = 'KristianRandall\\Bundle\\PortfolioBundle\\Model\\ProjectCategoryPeer';

    /**
     * The Peer class.
     * Instance provides a convenient way of calling static methods on a class
     * that calling code may not be able to identify.
     * @var        ProjectCategoryPeer
     */
     ...
     * @return ProjectCategory The current object (for fluent API support)
     */
    public function setProjectId($v)
    {
        ...
        if ($this->project_id !== $v) {
            $this->project_id = $v;
            $this->modifiedColumns[] = ProjectCategoryPeer::PROJECT_ID;
        }
    ...
    public function setCategoryId($v)
    {
        ...
        if ($this->category_id !== $v) {
            $this->category_id = $v;
            $this->modifiedColumns[] = ProjectCategoryPeer::CATEGORY_ID;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            return $startcol + 2; // 2 = ProjectCategoryPeer::NUM_HYDRATE_COLUMNS.
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = ProjectCategoryPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = ProjectCategoryQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                ProjectCategoryPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(ProjectCategoryPeer::PROJECT_ID)) {
            $modifiedColumns[':p' . $index++]  = '`project_id`';
        }
        if ($this->isColumnModified(ProjectCategoryPeer::CATEGORY_ID)) {
            $modifiedColumns[':p' . $index++]  = '`category_id`';
        }

        $sql = sprintf(
            'INSERT INTO `project_category` (%s) VALUES (%s)',
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(ProjectCategoryPeer::PROJECT_ID)) $criteria->add(ProjectCategoryPeer::PROJECT_ID, $this->project_id);
        if ($this->isColumnModified(ProjectCategoryPeer::CATEGORY_ID)) $criteria->add(ProjectCategoryPeer::CATEGORY_ID, $this->category_id);
    ...
    {
        $criteria = new Criteria(ProjectCategoryPeer::DATABASE_NAME);
        $criteria->add(ProjectCategoryPeer::PROJECT_ID, $this->project_id);
        $criteria->add(ProjectCategoryPeer::CATEGORY_ID, $this->category_id);
    ...
    public function isPrimaryKeyNull()
    {
        ...
        return (null === $this->getProjectId()) && (null === $this->getCategoryId());
    }
     ...
     * objects.
     *
     * @param object $copyObj An object of ProjectCategory (or compatible) type.
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return ProjectCategory Clone of current object.
     * @throws PropelException
     */
    ...
    public function getProject(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aProject === null && ($this->project_id !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                $this->aProject->addProjectCategories($this);
             */
        }
    ...
    public function getCategory(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aCategory === null && ($this->category_id !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aCategory->addProjectCategories($this);
             */
        }
    ...
    {
        return (string) $this->exportTo(ProjectCategoryPeer::DEFAULT_STRING_FORMAT);
    }
