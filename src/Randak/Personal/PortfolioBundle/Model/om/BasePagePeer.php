...
use \PropelException;
use \PropelPDO;
use Randak\Personal\PortfolioBundle\Model\Page;
use Randak\Personal\PortfolioBundle\Model\PagePeer;
use Randak\Personal\PortfolioBundle\Model\map\PageTableMap;
...
abstract class BasePagePeer
{
    ...
    const OM_CLASS = 'KristianRandall\\Bundle\\PortfolioBundle\\Model\\Page';
    ...
    protected static $fieldNames = array (
        ...
        BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'name', 'content', ),
        BasePeer::TYPE_COLNAME => array (PagePeer::ID, PagePeer::NAME, PagePeer::CONTENT, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID', 'NAME', 'CONTENT', ),
    ...
    protected static $fieldKeys = array (
        ...
        BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'name' => 1, 'content' => 2, ),
        BasePeer::TYPE_COLNAME => array (PagePeer::ID => 0, PagePeer::NAME => 1, PagePeer::CONTENT => 2, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID' => 0, 'NAME' => 1, 'CONTENT' => 2, ),
